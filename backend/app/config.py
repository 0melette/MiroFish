...
if os.path.exists(project_root_env):
    ...
    # If the project root does not contain a .env file, fall back to environment variables.
...
class Config:
    ...
    # JSON settings: disable ASCII escaping so non-ASCII text is emitted directly.
    JSON_AS_ASCII = False
