...
def generate_report():
    """
    Generate a simulation analysis report as an asynchronous task.
    ...
    try:
        ...
        # Check whether a completed report already exists.
        ...
        # Generate report_id up front so it can be returned immediately to the frontend.
        import uuid
